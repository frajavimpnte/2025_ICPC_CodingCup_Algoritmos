...
*   by FJMP
*   Dynamic Programming DEMO: part1 brute force, all
*   Programmer: FJMP
*   23/enero/2025
*
*        win: c++ exercise39_subset_sum_all.cpp -o exercise39_subset_sum_all.exe
*              exercise39_subset_sum_all.exe
*         ps: .\exercise39_subset_sum_all.exe
*  linux mac: c++ exercise39_subset_sum_all.cpp -o exercise39_subset_sum_all
*             ./exercise39_subset_sum_all
**************************************************************************************/
	...
	for(int i = 0; i < tests; i++)
	{
		...
		switch(i)
		{
			...
			case 3:
			{
                ...
                // print all subsetsums
				//for(auto sum : subsetSums) cout << sum << " "; cout << endl;
